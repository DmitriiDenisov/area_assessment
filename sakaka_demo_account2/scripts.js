...
(function () {
    ...
    // ==========================================================
    // ==========================================================
	//'pk.eyJ1Ijoib21hbmd1dG92IiwiYSI6ImNpenpvNWtmajAwMjgzMnBmYXp6enhuOTIifQ.KwVxe-y3-a_BeY-uHqBoag'
    mapboxgl.accessToken = 'pk.eyJ1IjoiYXJlYTAzMjciLCJhIjoiY2oxYng4dDlxMDA0YTMzcGEzanV3cXozdCJ9.xm6a-ZNCtWd2ULIrPUjnlQ';
    ...
    var mapSettings = {
        cursor: '',
        style: {
            baseURI: 'mapbox://styles/area0327/', //'mapbox://styles/omangutov/',
            defaultStyle: 'cj1c3w7sc00cx2sonqc3xx02d' //'cj0tpd64o00j82rnphr76axim'
        }
    };
    ...
    var stylesModule = (function () {
        ...
        var styles = {
            satellite: {
                url: 'cj1c3w7sc00cx2sonqc3xx02d',//'cj0tpd64o00j82rnphr76axim',
                name: 'Satellite'
            },
            streets: {
                url: 'cj1c3vh8s00ea2ro13wvmtoau',//'cj122xjma00312rm0odq908lt',
                name: 'Streets'
            },
            dark: {
                url: 'cj1c3tz7c00bw2sn3bzbcg4us',//'cj123niht008c2so78qf96zla',
                name: 'Dark'
            }
        };
