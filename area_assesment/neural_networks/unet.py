...
def unet_old(patch_height, patch_width, n_ch):
    ...
    model.compile(optimizer='adam', loss='binary_crossentropy', metrics=['binary_crossentropy', precision, # 'binary_accuracy'
...
def unet(pretrained_weights=None, input_size=(256, 256, 1)):
    ...
    model.compile(optimizer=Adam(lr=1e-4), loss='binary_crossentropy',  metrics=['binary_crossentropy', precision, # 'binary_accuracy'
                                                                        recall, fmeasure, dice_coef_K, jaccard_coef])
