...
for i, (f_sat, f_map) in enumerate(list(zip(train_sat_files, train_map_files))):
    ...
    img_sat_patches = extract_patches_2d(img_sat, nn_input_patch_size, max_patches=500, random_state=1)
    img_map_patches = extract_patches_2d(img_map, nn_input_patch_size, max_patches=500, random_state=1)
